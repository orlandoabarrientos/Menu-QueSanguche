...
def _match_currency(container_text: str) -> set[str]:
...
def get_bcv_rates(
    ...
    *,
    ...
    try:
        ...
        logging.getLogger(__name__).error("Error fetching BCV homepage: %s", exc)
        raise ScraperError("No se pudo obtener la página del BCV") from exc
